...
alias cshc='cd ~/git_projects/cules-shop/client/' 
alias cshcv='cd ~/git_projects/cules-shop/client/' 

alias ccbv='cd ~/git_projects/cules-coding/src/ && nvim .'
alias ccbs='cd ~/git_projects/cules-coding/src/ && yarn dev'
alias ccb='cd ~/git_projects/cules-coding/'
